...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const fetchListings = async () => {
      ...
      setLoading(false);
      if (data.length > 0)
        showToast(true, "Listings found successfully");
      else 
        showToast(false, "Listings not found");
    }
  ...
  return (
    <div className="flex flex-col max-w-screen-2xl mx-auto md:flex-row">
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8 top-[100px] sticky">
          ...
          <div className="flex gap-2 items-center">
            ...
            <select id="sort_order" className="border rounded-lg p-3" defaultValue={'created_at_desc'} onChange={handleChange}>
      ...
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {!loading && listings && listings.map((listing) => (
            <ListingComponent key={listing._id} listing={listing} />
          ))}
          {showMore && (
